  ...
  return (
    <DashboardLayout title="Crawler truyện từ nguồn Otruyen">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  updateOptions({ startPage: parseInt(e.target.value) || 1 })
                }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  updateOptions({
                    endPage: parseInt(e.target.value) || options.startPage,
                  })
                }
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-green-500 focus:border-green-500 dark:bg-gray-800 dark:text-white"
              />
            ...
            <div className="flex space-x-3 mt-6">
              <Button
                ...
                disabled={
                  isLoading || progress?.status === CrawlerStatus.IN_PROGRESS
                }
                className="flex-1"
              >
              ...
              <Button
                ...
                disabled={
                  !isConnected || progress?.status !== CrawlerStatus.IN_PROGRESS
                }
                className="flex-1"
              >
        ...
        <div className="bg-green-50 dark:bg-gray-800 p-4 rounded-lg border border-green-200 dark:border-gray-600">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span
                className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusColor()} bg-opacity-20 text-opacity-100`}
              >
                {getStatusText()}
              </span>
            </div>
                ...
                <div className="grid grid-cols-2 gap-2 mt-2">
                  <div className="bg-white dark:bg-gray-700 p-2 rounded-md shadow-sm">
                    ...
                    <p className="text-lg font-semibold text-gray-800 dark:text-white">
                      {progress.totalComicsProcessed || 0}
                    </p>
                  </div>
                  <div className="bg-white dark:bg-gray-700 p-2 rounded-md shadow-sm">
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                    ...
                    <p className="text-lg font-semibold text-gray-800 dark:text-white">
                      {progress.totalSuccessfulComics || 0}
                    </p>
                  </div>
                </div>
              </>
      ...
      <div className="bg-green-50 dark:bg-gray-800 p-4 rounded-lg border border-green-200 dark:border-gray-600">
          ...
          <div className="mb-4 p-3 bg-white dark:bg-gray-700 rounded-md shadow-sm">
            ...
            {progress.currentComicChaptersProcessed !== undefined && (
              <p className="text-sm text-gray-600 dark:text-gray-300">
                Chapter đã xử lý: {progress.currentComicChaptersProcessed}
              </p>
            )}
          </div>
        )}
        ...
        {lastCompletedChapter &&
          Object.keys(lastCompletedChapter).length > 0 && (
            <div className="mb-4 p-3 bg-white dark:bg-gray-700 rounded-md shadow-sm">
              <h3 className="text-sm font-medium text-gray-800 dark:text-white mb-2">
                Chapter mới nhất đã crawl:
              </h3>
              <p className="text-lg font-semibold text-green-600 dark:text-green-400">
                {lastCompletedChapter.comicName}
              </p>
              <p className="text-sm text-gray-600 dark:text-gray-300">
                Chapter: {lastCompletedChapter.chapterNumber} -{" "}
                {lastCompletedChapter.chapterTitle}
              </p>
              <p className="text-sm text-gray-600 dark:text-gray-300">
